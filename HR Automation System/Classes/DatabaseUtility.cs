...
namespace HR_Automation_System.Classes
{
    public class DatabaseUtility
    {
        ...
        public void AddFamilyStatus(string status)
        {
            ...
            cmd.Parameters.AddWithValue("@Status_Index", 0);
            ...
            cmd.CommandText = "SELECT LAST(status_id) AS return_value FROM family_statuses";
            ...
            while (dr.Read())
            {
                id = int.Parse(dr["return_value"].ToString());
            }
        }
    }
}
